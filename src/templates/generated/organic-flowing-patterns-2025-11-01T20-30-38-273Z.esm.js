/**
 * Generated Template: organic-flowing-patterns-2025-11-01T20-30-38-273Z (ES Module Version)
 ...
 *   // or
 *   import { meta, render } from './organic-flowing-patterns-2025-11-01T20-30-38-273Z.esm.js';
 */
export const meta = {
  ...
  inputs: [
    {
      key: "palette",
      type: "color[]",
      default: ["#0074D9", "#39CCCC", "#2ECC40", "#FF4136"],
    },
    {
      key: "noiseScale",
      type: "number",
...
export const render = (p, params, seed) => {
  ...
  const palette =
    params.palette && params.palette.length
      ? params.palette
      : ["#0074D9", "#39CCCC", "#2ECC40", "#FF4136"];
  ...
  for (let i = 0; i < count; i++) {
    ...
    for (let t = 0; t < 200; t++) {
      const angle =
        p.noise(x * noiseScale, y * noiseScale, t * zSpeed) * p.TAU * 2;
