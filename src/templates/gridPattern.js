 ...
 * Creates structured grid-based compositions
 */
module.exports = function gridPattern(params) {
  const { colors, density, movement, shapes } = params;
  const primaryShape = shapes[0] || "rect";
      ...
      for (let j = 0; j < gridSize; j++) {
        ...
        ${
          primaryShape === "circle"
            ...
            : primaryShape === "rect"
            ? `p5.rectMode(p5.CENTER); p5.rect(x, y, size, size);`
